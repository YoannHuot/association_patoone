const dogsObject = {
	...
	stella: {
		...
		profil: "Si Stella adore les humains, elle n'en est pas moins une caractérielle qui se laisse difficilement approchée par ses congénères ou d'autres animaux. Du fait de sa petite taille, Stelle s'adaptera à une vie en appartement.",
	...
	andre: {
		...
		appartement: true,
		description:
			"Andre est un Shiba d'âge moyenne. Il a été secouru de son précédent foyer où il était maltraité par ses anciens propriétaires. Il apprécie sa vie en famille d'accueil mais garde toutefois des réserves vis-à-vis des humains. Il faudra du temps, de la patience et la compassion pour qu'il se livre à nouveau.  ",
